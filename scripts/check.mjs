...
if (manifest.id !== 'gib-atlas' || manifest.version !== '0.2.0') throw new Error('Unexpected manifest identity');
const main = fs.readFileSync(new URL('../main.js', import.meta.url), 'utf8');
for (const marker of ['Gib Atlas', 'Xenova/bge-small-en-v1.5', 'VIEW_TYPE', 'documentChunks', 'stableCommunities', 'commonSignalRemoval']) {
