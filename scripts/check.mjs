...
if (manifest.id !== 'gib-atlas' || manifest.version !== '0.5.0') throw new Error('Unexpected manifest identity');
...
for (const marker of ['Terrain laboratory', 'gib-atlas-terrain-lab', 'HEIGHT_SHADER', 'RELIEF_SHADER', 'WebGL 2']) {
